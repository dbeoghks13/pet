...
public class PFileboardDto {
	...
	public PFileboardDto() { }
	public PFileboardDto(int fId, String mId, String fTitle, String fContent, String fFileName, Date fRdate, int fHit,
	...
	public String toString() {
		return "pFileBoard [fId=" + fId + ", mId=" + mId + ", fTitle=" + fTitle + ", fContent=" + fContent
